...
@TeleOp(name="Drive To All Four Targets", group = "Concept")
@Disabled
public class DriveToAllFourTargets extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (targetPosition!=null) {
                ...
                driveTowardsTarget(targetPosition);
            } else {
    ...
    private void driveTowardsTarget(NavTargetPosition targetPosition) {
        ...
        leftFrontWheelMotor.setPower(leftPower);
        leftRearWheelMotor.setPower(leftPower);
        rightRearWheelMotor.setPower(rightPower);
        rightFrontWheelMotor.setPower(rightPower);

        do {
            targetPosition = identifyNavigationTarget(targetsFreightFrenzy);
        } while (targetPosition.getRange()>1);
    }


    public void driveToFourTarget() {
